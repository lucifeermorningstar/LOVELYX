...
➪ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴍᴀsᴛᴇʀ](t.me/Alain_Xd) ғᴏʀ ᴀɴʏ ǫᴜᴇʀʏ ᴀɴᴅ [ᴀᴘᴘᴇᴀʟ](https://t.me/lucifeermorningstar) ʜᴇʀᴇ.

➪ ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ʜᴇʟᴘ ᴛᴏ ᴇxᴘʟᴏʀᴇ ᴍᴏʀᴇ ᴀʙᴏᴜᴛ ᴍᴇ ᴀɴᴅ ᴍʏ ғᴇᴀᴛᴜʀᴇs.

➪ Pᴏᴡᴇʀᴇᴅ ʙʏ [skem](t.me/alain_xd)
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Aᴅᴅ ᴇʟɪsᴀ ᴛᴏ ɢʀᴏᴜᴘ ➕️", url="t.me/MissElisaRoBot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="✨ᴇʟɪsᴀ ʟᴏɢs✨", url="t.me/DaisyXNetwork"),
        InlineKeyboardButton(
            text="👥Sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ👥", url="https://t.me/Alain_XD"),
    ],
    [  
        InlineKeyboardButton(text="😈ᴇᴋɪsᴀ ᴅᴇᴠs😈", url="https://t.me/Alain_XD"
    ),
    ], 
    [
        InlineKeyboardButton(text="❤️ᴋᴡɴᴇʀ❤️", url="https://t.me/Alain_XD"
    ), 
    ],
    [   
...
HELP_STRINGS = """
༆*ᴇʟɪsᴀ comes with many special features in it*༆
꧁*CHECK ALL BUTTON BELOW TO EXPLORE EVERY COMMANDS OF LOVELY*꧂
𖣘 *All commands can either be used with* `/` *or* `!`.
𖣘 *If you facing any issue or find any bugs in any command then you can report it in @Alain_XD* [.](https://telegra.ph/file/cbbf01ed6f013ce07d54f.jpg)
"""
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *ELISA*, a powerful group management bot built to help you manage your group easily.
                 ...
                 Here is the [💾Repository](https://t.me/alain_xd).
                 If you have any question about Lovely, let us know at @ALAIN_XD.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Elisa is back with explosive features.✨")
        except Unauthorized:
            LOGGER.warning(
